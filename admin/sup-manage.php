...
if ($_GET['del']) {
    $sid = $_GET['del'];
    mysqli_query($con, "delete from tblsupplier where sno ='$sid'");
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <!-- <li><a href="sup-add.php">Add Supplier</a></li> -->
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Manage Supplier</strong>
                            <span style="float:right;">
								<abbr title="Add New" style="cursor: pointer" class="abbr_class"><a href="sup-add.php"><img src="images/add.png" class="image_safe" style="width:30px;height:30px;"></a></abbr>
							</span>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <abbr title="Edit" style="cursor: pointer" class="abbr_class"><a href="sup-edit.php?editid=<?php echo $row['sno']; ?>">
                                                    <img src="images/eee.png" style="width:25px;" class="image_safe">
                                            </abbr>

                                            <abbr title="Delete" style="cursor: pointer" class="abbr_class">
                                                <a href="sup-manage.php?del=<?php echo $row['sno']; ?>" onClick="return confirm('Are you sure you want to delete?')">
