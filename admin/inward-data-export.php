...
header("Content-Disposition: attachment; filename=Inward_Details.xls");
...
echo '<h2>Inward Details Report</h2>';
...
echo '<tr>
        ...
        <th width="30%" style="background-color: #800080; color: #FFFFFF; text-align: center;">Supplier Name</th>
        ...
        <th width="20%" style="background-color: #800080; color: #FFFFFF; text-align: center;">CheckedBy</th>
      </tr>';

$fdate = $_GET['date']; 

$query = "SELECT sno, supplier, category, type, subtype, quantity, unit, billno, challen, checkedby , mat_loc, mat_status
          FROM tblinward 
...
while ($row = mysqli_fetch_assoc($result)) {
  ...
  echo '<tr class="' . $row_class . '">
            ...
            <td>' . htmlspecialchars($row['checkedby'], ENT_QUOTES, 'UTF-8') . '</td>
          </tr>';
  $row_count++;
}
