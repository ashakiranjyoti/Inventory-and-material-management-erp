                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="report-ven-manage.php" method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport">
                                <p style="font-size:16px; color:red" align="center"> <?php if ($msg) {
                                                                                            echo $msg;
                                                                                        }  ?> </p>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="vendor" class="form-control-label">Select Vendor</label></div>
