...
if (isset($_POST['submit'])) {
    ...
    if ($quantity <= $available_quantity) {
        $query = mysqli_query($con, "UPDATE tblreq SET category='$category', type='$type', subtype='$subtype', available_quantity='$available_quantity', quantity='$quantity', unit='$unit', purpose='$purpose', des='$des', time='$time' WHERE sno='$eid'");
        if ($query) {
...
$eid = $_GET['editid'];
$ret = mysqli_query($con, "SELECT * FROM tblreq WHERE sno='$eid'");
