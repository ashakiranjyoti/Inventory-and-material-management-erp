...
if ($_GET['del']) {
    $catid = $_GET['del'];
    mysqli_query($con, "delete from tblcat where sno ='$catid'");
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <!-- <li><a href="cat-add.php">Add Category</a></li> -->
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <abbr title="Add New" style="cursor: pointer" class="abbr_class"><a href="cat-add.php"><img src="images/add.png" class="image_safe" style="width:30px;height:30px;"></a></abbr>
                            </span>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                <?php
                                $ret = mysqli_query($con, "select * from tblcat ");
                                $cnt = 1;
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['cat_subtype']; ?></td> -->

                                        <td>
                                            <abbr title="Edit" style="cursor: pointer" class="abbr_class"><a href="cat-edit.php?editid=<?php echo $row['sno']; ?>">
                                                    <img src="images/eee.png" style="width:25px;" class="image_safe">
                                            </abbr>

                                            <abbr title="Delete" style="cursor: pointer" class="abbr_class">
                                                <a href="cat-manage.php?del=<?php echo $row['sno']; ?>" onClick="return confirm('Are you sure you want to delete?')">
