...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $gst = $_POST['gst'];
    $query = mysqli_query($con, "INSERT INTO tblsupplier(name, address, contact, email, gst) VALUES ('$name', '$address', '$contact', '$email', '$gst')");
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="name" name="name" class="form-control" placeholder="Supplier Name" required="true"></div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="contact" name="contact" class="form-control" placeholder="Contact" required="true"></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Email</label></div>
                                    <div class="col-12 col-md-9"><input type="email" id="email" name="email" class="form-control" placeholder="Email" required="true"></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">GST</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="gst" name="gst" class="form-control" placeholder="GST" required="true"></div>
                                </div>
