...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO unit(unit_name, type) VALUES ('$unit_name', '$type')");
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="unit_name" name="unit_name" class="form-control" placeholder="Unit Name" required="true"></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Unit Type</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="type" name="type" class="form-control" placeholder="Unit Type" required="true"></div>
                                </div>
