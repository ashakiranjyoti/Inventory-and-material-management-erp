...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update tbltype set cat='$cat' , type_name='$type_name' where sno='$eid'");
    if ($query) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <?php
                                $cid = $_GET['editid'];
                                $ret = mysqli_query($con, "select * from  tbltype where sno='$cid'");
                                $cnt = 1;
                                ...
                                ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="cat" id="cat" class="form-control" required>
                                                ...
                                                <?php
                                                $query_cat = mysqli_query($con, "SELECT * FROM tblcat");
                                                while ($row_cat = mysqli_fetch_array($query_cat)) {
                                                    $selected = ($row_cat['cat_name'] == $row['cat']) ? 'selected' : '';
                                                    echo "<option value='" . $row_cat['cat_name'] . "' " . $selected . ">" . $row_cat['cat_name'] . "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="type_name" name="type_name" class="form-control" placeholder="Type name" required="true" value="<?php echo $row['type_name']; ?>"></div>
                                    </div>
