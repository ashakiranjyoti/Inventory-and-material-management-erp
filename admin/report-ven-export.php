...
if (isset($_GET['vendor_name'], $_GET['fromdate'], $_GET['todate'])) {
    ...
    header("Content-Disposition: attachment; filename=Vendor_Report_Export.xls");
    ...
    echo '<h2>Vendor Report Details</h2>';
    ...
    echo '<tr>
            ...
            <th width="10%" style="background-color: #800080; color: #FFFFFF; text-align: center;">Purpose</th>
            <th width="10%" style="background-color: #800080; color: #FFFFFF; text-align: center;">Des</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr class="' . $row_class . '">
                ...
                <td>' . (($row['source'] == 'Inward') ? '---' : htmlspecialchars($row['purpose'], ENT_QUOTES, 'UTF-8')) . '</td>
                <td>' . (($row['source'] == 'Inward') ? '---' : htmlspecialchars($row['des'], ENT_QUOTES, 'UTF-8')) . '</td>
