                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <!-- <li><a href="req-add.php">Add</a></li> -->
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span style="float:right;">
								<abbr title="Add New" style="cursor: pointer" class="abbr_class"><a href="req-add.php"><img src="images/add.png" class="image_safe" style="width:30px;height:30px;"></a></abbr>
							</span>
                        </div>
                        <div class="card-body">
                            <?php
                            // Fetch data for the specified date
                            $ret = mysqli_query($con, "SELECT * FROM tblreq WHERE DATE(time) = '$fdate'");
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <abbr title="Edit" style="cursor: pointer" class="abbr_class"><a href="req-edit.php?editid=<?php echo $row['sno']; ?>">
                                                            <img src="images/eee.png" style="width:25px;" class="image_safe">
                                                    </abbr>

                                                    <abbr title="Delete" style="cursor: pointer" class="abbr_class">
                                                        <a href="req-manage.php?del=<?php echo $row['sno']; ?>" onClick="return confirm('Are you sure you want to delete?')">
