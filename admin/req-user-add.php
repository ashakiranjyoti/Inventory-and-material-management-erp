                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="req-user-manage.php">Requirement</a></li>
                        ...
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <abbr title="Back" style="cursor: pointer" class="abbr_class">
                                    <a href="req-user-manage.php"><img src="images/back-new.png" class="image_safe" style="width:30px;height:30px;margin-right:0px;"></a>
                                </abbr>
                            </span>
                        </div>
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="req_name" name="req_name" class="form-control" placeholder="Name" required="true" readonly value="<?php echo htmlspecialchars($reqName); ?>">
                                </div>
                            </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="time" class="form-control-label">Date & Time</label></div>
                                    <div class="col-12 col-md-9">
                                        <input type="datetime-local" id="time" name="time" class="form-control" placeholder="Date & Time" required="true" value="<?php echo date('Y-m-d\TH:i'); ?>" readonly>
                                    </div>
                                </div>
