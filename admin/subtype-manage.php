                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Manage SubType</strong>
                            <span style="float:right;">
								<abbr title="Add New" style="cursor: pointer" class="abbr_class"><a href="subtype-add.php"><img src="images/add.png" class="image_safe" style="width:30px;height:30px;"></a></abbr>
							</span>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><?php echo $row['avail_quant']; ?></td> -->


                                        <td>
                                            <abbr title="Edit" style="cursor: pointer" class="abbr_class"><a href="subtype-edit.php?editid=<?php echo $row['sno']; ?>">
                                                    <img src="images/eee.png" style="width:25px;" class="image_safe">
                                            </abbr>
                                    
                                            <abbr title="Delete" style="cursor: pointer" class="abbr_class">
                                                <a href="subtype-manage.php?del=<?php echo $row['sno']; ?>" onClick="return confirm('Are you sure you want to delete?')">
