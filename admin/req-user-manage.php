...
if (isset($_GET['del'])) {
    $sid = $_GET['del'];
    mysqli_query($con, "DELETE FROM tblreq WHERE sno ='$sid'");
    echo "<script>window.location.href='req-user-manage.php'</script>";
}

$reqName = $_SESSION['name']; // Fetch logged-in user's name
...
<head>
    <title>Inventory Management System - User Requirement</title>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <!-- <li><a href="req-user-add.php">Add</a></li> -->
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span style="float:right;">
								<abbr title="Add New" style="cursor: pointer" class="abbr_class"><a href="req-user-add.php"><img src="images/add.png" class="image_safe" style="width:30px;height:30px;"></a></abbr>
							</span>
                        </div>
                        <div class="card-body">
                            <?php
                            // Fetch data for the logged-in user and specified date
                            $ret = mysqli_query($con, "SELECT * FROM tblreq WHERE req_name = '$reqName' AND DATE(time) = '$fdate'");
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <abbr title="Edit" style="cursor: pointer" class="abbr_class"><a href="req-user-edit.php?editid=<?php echo $row['sno']; ?>">
                                                            <img src="images/eee.png" style="width:25px;" class="image_safe">
                                                    </abbr>

                                                    <abbr title="Delete" style="cursor: pointer" class="abbr_class"><a href="req-user-manage.php?del=<?php echo $row['sno']; ?>" onClick="return confirm('Are you sure you want to delete?')">
