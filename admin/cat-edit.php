                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <?php
                                $cid = $_GET['editid'];
                                $ret = mysqli_query($con, "select * from  tblcat where sno='$cid'");
                                $cnt = 1;
                                ...
                                ?>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="cat_name" name="cat_name" class="form-control" placeholder="Category Name" required="true" value="<?php echo $row['cat_name']; ?>"></div>
                                    </div>

                                    <div class="row form-group" hidden>
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Description</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="des" name="des" class="form-control" placeholder="Description" value="<?php echo $row['des']; ?>"></div>
                                    </div>
